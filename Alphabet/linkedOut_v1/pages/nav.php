...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b>Linked</b>OUT</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        ...
        <span class="icon-bar"></span>
          ...
          <div class="col-md-6">
            <!-- search form -->
              <form action="search.php" method="get" class="" style="padding-top: 7px;">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <i class="fa fa-shopping-cart text-green"></i> 25 jobs for you
                    </a>
                  </li>
                  <li>
                    <a href="#">
